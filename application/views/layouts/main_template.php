...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?=$CI->uri->segment(1) == 'member' ? 'active' : '' ?>">
                ...
                <div id="collapseBooks" class="collapse <?=($CI->uri->segment(1) == 'member' || $CI->uri->segment(1) == 'publisher' || $CI->uri->segment(1) == 'kategori') ? 'show' : '' ?>" 
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?=$CI->uri->segment(1) == 'member' ? 'active bg-dark text-light' : '' ?>" href="<?=base_url('member')?>">
							<i class="fa fa-user" aria-hidden="true"> </i>
							<span>Member</span>
						</a>

                        <a class="collapse-item <?=$CI->uri->segment(1) == 'publisher' ? 'active bg-dark text-light' : '' ?>" href="<?=base_url('publisher')?>">
							<i class="fa fa-building" aria-hidden="true"></i>
							<span>Penerbit</span>
						</a>

						<a class="collapse-item <?=$CI->uri->segment(1) == 'kategori' ? 'active bg-dark text-light' : '' ?>" href="<?=base_url('kategori')?>">
            ...
            <!-- Nav Item - Book -->
            <li class="nav-item <?=$CI->uri->segment(1) == 'book' ? 'active bg-dark' : '' ?>">
			 ...
			 <!-- Nav Item - Peminjaman -->
			 <li class="nav-item <?=$CI->uri->segment(1) == 'order' ? 'active bg-dark' : '' ?>">
            ...
            <!-- Nav Item - Users -->
            <li class="nav-item <?=$CI->uri->segment(1) == 'user' ? 'active bg-dark' : '' ?>">
